...
class SummonerModal(Modal):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        file = discord.File(summoner.getSummonerIconURL(), filename=f"{summoner.icon_id}.png")
        embed = discord.Embed(title=interaction.user.name, description="Please change your profile icon in the League of Legends client to the following to validate your account.")
